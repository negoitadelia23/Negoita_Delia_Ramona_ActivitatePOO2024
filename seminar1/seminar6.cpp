...
string operator[](int index)
{
	...
	else throw "Indexul se afla in afara limitelor";//sunt niste chestii care se numest throw try catch
}
...
class DaciaLogan :public Masina {
private:
	int caiPutere;
public:
	DaciaLogan() :Masina()
	...
	DaciaLogan(int caiputere, int nrRoti, string* producatori, string marca, float pret, const int anFabricatie):Masina(){}
};
int main() {
	Masina m;
